...
export default class Engine {
  ...
  public addComponent<T extends typeof Component>(entity: Entity, type: T, props: Record<string, any> = {}) {
  ...
  public addComponents(entity: Entity, components: CreateEntityComponents) {
  ...
  public removeComponents<T extends typeof Component>(entity: Entity, type: T) {
