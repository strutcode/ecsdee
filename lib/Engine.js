...
class Engine {
    ...
    addSystem(type, options) {
        const opts = Object.assign({ existingAsCreated: true }, options);
    ...
    getCreated(type) {
        ...
        if (this.activeSystem) {
            const systemChanges = (_b = (_a = this.systemChanges.get(this.activeSystem)) === null || _a === void 0 ? void 0 : _a.created) !== null && _b !== void 0 ? _b : [];
            const standardChanges = (_c = this.componentChanges.created.get(type)) !== null && _c !== void 0 ? _c : [];
            return [...systemChanges, ...standardChanges];
        }
        return ((_d = this.componentChanges.created.get(type)) !== null && _d !== void 0 ? _d : []);
    }
